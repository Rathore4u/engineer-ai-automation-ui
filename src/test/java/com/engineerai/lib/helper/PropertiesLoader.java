...
public class PropertiesLoader
{
	...
	public Properties load(final String propertyFile)
	{
		...
		catch (final IOException e)
		{
			try
			{
				throw new com.engineerai.lib.helper.ScumberException("Failed to load property file : " + propertyFile, e);
			}
			catch (final com.engineerai.lib.helper.ScumberException e1)
			{
				e1.printStackTrace();
			}
		}
